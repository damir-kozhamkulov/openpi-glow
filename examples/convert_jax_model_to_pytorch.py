...
def convert_pi0_checkpoint(
    ...
    # Copy assets (norm stats). Checkpoints keep assets/ inside the checkpoint directory,
    # next to params/; fall back to the parent for layouts that keep it alongside instead.
